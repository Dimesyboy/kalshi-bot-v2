...
if (home_abbr.startswith(a1[:2]) or a1.startswith(home_abbr[:2])) and                (away_abbr.startswith(a2[:2]) or a2.startswith(away_abbr[:2])):
return True
if (home_abbr.startswith(a2[:2]) or a2.startswith(home_abbr[:2])) and                (away_abbr.startswith(a1[:2]) or a1.startswith(away_abbr[:2])):
return True
